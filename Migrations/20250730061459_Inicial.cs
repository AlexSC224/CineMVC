        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioEntrada = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Peliculas",
                columns: new[] { "Id", "Activa", "Clasificacion", "Duracion", "Genero", "ImagenBase64", "Sinopsis", "Titulo" },
                values: new object[,]
                {
                    { 1, true, "+13", "3h 2min", "Acción", "", "Los Vengadores restantes luchan por restaurar el universo.", "Avengers: Endgame" },
                    { 2, true, "ATP", "1h 45min", "Animación", "", "Un niño se adentra en la Tierra de los Muertos para encontrar a su tatarabuelo.", "Coco" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Funciones",
                columns: new[] { "Id", "FechaHora", "PeliculaId", "PrecioEntrada", "SalaId" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 8, 1, 18, 0, 0, 0, DateTimeKind.Unspecified), 1, 30.00m, 1 },
                    { 2, new DateTime(2025, 8, 2, 16, 0, 0, 0, DateTimeKind.Unspecified), 2, 25.00m, 2 }
                });
